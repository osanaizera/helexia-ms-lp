    ...
    <main>
      ...
      <section className="container-pad py-12 bg-bg">
        ...
        <div className="mt-6 space-y-3">
          ...
          <details className="card"><summary className="p-4 font-medium">Minha conta precisa ser maior que R$ 1.000?</summary><div className="card-body pt-0">Sim, atualmente atendemos contas a partir de R$ 1.000/mês no MS.</div></details>
